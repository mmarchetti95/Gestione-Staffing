...
## Corpus Check
- 48 files · ~225,812 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 872 nodes · 1404 edges · 81 communities (53 shown, 28 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72457bec`
...
- Doppia Week Module
- Auth Roles & Admin Panels
- Dashboard Screen & Core Sync
- Geocoding & Routing Services
- Attestati & DPI Badges
- Backup & Restore
- Excel Import/Export
...
- KPI Dashboard
- PDF Export (jsPDF)
- Visual Restyling v18.69
- Alerts Rendering
- INITIAL_DATA Fallback
- Shadow & Glow Design Rules
- Product Constraints
- Cursor Fix (Operator Card)
- Read-Only Mode UI
- Sticky Toolbar (Griglia)
- Version Update Banner
- Convention: No Duplicate Functions
- Convention: No Nested Templates
- Checkpoint Skill
- Deep Teal Accent Color
- Design Rule: No Side Tabs
- Jira Start Date Field
- Jira Target Production Field
- Accessibility Principle
- Brand Commitments
- Evidence-on-Hand Principle
- Operating Context
- Product Positioning
...
- `.pw-ctx-menu context menu (copy/paste cantiere/attività, right-click)` --references--> `Griglia tab (team/site/tool assignment grid)`  [INFERRED]
  src/head.html → CLAUDE.md
- `.modal-backdrop CSS class (z-index 100050)` --implements--> `Confirm/alert modal must render above all other modals (.modal-backdrop z-index ceiling, currently 100050)`  [INFERRED]
  src/head.html → CLAUDE.md
- `Confirm/alert modal must render above all other modals (.modal-backdrop z-index ceiling, currently 100050)` --cites--> `v18.114.0 confirm/alert modal z-index bumped to 10050 above Leaflet controls`  [INFERRED]
  CLAUDE.md → README.md
...
### Community 5 - "Meteo & Bollettino Widget"
Cohesion: 0.12
...
Cohesion: 0.15
Nodes (26): closeModal(), cpSelectModal(), deleteCommessa(), deleteOperatore(), esc(), getOperatoriAttivi(), HELP_TEXTS, isOperatoreLicenziato() (+18 more)
...
### Community 9 - "Strumenti & Squadre Editing"
Cohesion: 0.13
...
### Community 10 - "New-Project Skill Scaffold"
Cohesion: 0.08
...
### Community 12 - "Build Pipeline & App Shell"
Cohesion: 0.11
...
### Community 15 - "Operatori Pool Management"
Cohesion: 0.19
...
### Community 16 - "Claude Skills Scaffolding"
Cohesion: 0.14
...
### Community 17 - "Search Popover & Stats"
Cohesion: 0.21
...
### Community 18 - "Design System Tokens"
Cohesion: 0.19
...
### Community 19 - "Staffing Assignments"
Cohesion: 0.21
...
### Community 20 - "Operator Selection Modal"
Cohesion: 0.28
...
### Community 21 - "Jira Custom Fields Docs"
Cohesion: 0.20
...
### Community 22 - "index.html Build Artifact"
Cohesion: 0.17
...
### Community 26 - "Produzione Report Export"
Cohesion: 0.33
...
### Community 29 - "Anagrafica Import"
Cohesion: 0.36
...
### Community 32 - "Griglia & Jira Subtask Creation"
Cohesion: 0.32
...
### Community 33 - "Modal Z-Index Convention"
Cohesion: 0.32
...
### Community 36 - "Dashboard Screen & Core Sync"
Cohesion: 0.29
...
### Community 37 - "Geocoding & Routing Services"
Cohesion: 0.43
...
### Community 38 - "Attestati & DPI Badges"
Cohesion: 0.29
...
### Community 42 - "Smoke Test Script"
Cohesion: 0.47
...
### Community 43 - "Supabase & GitHub Pages Setup"
Cohesion: 0.33
...
### Community 47 - "Staffing Grid Cells"
Cohesion: 0.60
...
## Knowledge Gaps
- **166 isolated node(s):** `HELP_TEXTS`, `_cpData`, `_pwCollapsedComm`, `_pwCollapsedSq`, `_cpCollapsedComm` (+161 more)
...
- **What connects `HELP_TEXTS`, `_cpData`, `_pwCollapsedComm` to the rest of the system?**
