# Graph Report - Gestione-Staffing  (2026-08-31)

## Corpus Check
- 40 files · ~156,999 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 603 nodes · 896 edges · 72 communities (35 shown, 37 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfb535d4`
...
3. `pwSpostDrawMap()` - 11 edges
4. `pwGetFerieWeek()` - 11 edges
5. `closeModal()` - 10 edges
6. `Dashboard Staffing (Eagleprojects app)` - 10 edges
7. `pwSpostRenderResult()` - 9 edges
8. `pwFerieRender()` - 9 edges
9. `pwGeneraMail()` - 9 edges
...
Cohesion: 0.13
Nodes (25): commessaRegione(), _geoCache, _geoCacheSave(), geocodifica(), MAP_COLORS, _mapCollapsedCommesse, _mapCollapsedRegioniOp, _mapColor() (+17 more)
...
### Community 70 - "weekly-ferie-import.js"
Cohesion: 0.23
...
### Community 71 - "weekly-spostamenti.js"
Cohesion: 0.18
...
## Knowledge Gaps
- **111 isolated node(s):** `_pwActiveTab`, `_pwScrollY`, `_pwSpostLayers`, `_pwSpost`, `pwData` (+106 more)
...
- **Why does `esc()` connect `dashboard-crud-helpers.js` to `weekly-jira-subtask.js`, `weekly-ferie-import.js`?**
...
- **What connects `_pwActiveTab`, `_pwScrollY`, `_pwSpostLayers` to the rest of the system?**
